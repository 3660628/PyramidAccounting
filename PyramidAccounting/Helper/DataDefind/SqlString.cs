...
namespace PA.Helper.DataDefind
{
    class SqlString
    {
        ...
        private static readonly string insert_T_BOOKS = "insert into @T_BOOKS(ID,BOOK_NAME,COMPANY_NAME,MONEY_TYPE,CREATE_DATE,ACCOUNTING_SYSTEM) "
            + "values (@ID, @BOOK_NAME,@COMPANY_NAME, @MONEY_TYPE, @CREATE_DATE, @ACCOUNTING_SYSTEM)";
