...
namespace PA.Helper.DataDefind
{
    class SqlString
    {
        ...
        private static readonly string insert_T_VOUCHER = "Insert into @T_VOUCHER(ID,OP_TIME,PERIOD,SUBSIDIARY_COUNTS,FEE_DEBIT,FEE_CREDIT,ACCOUNTANT,BOOKEEPER,REVIEWER,REVIEW_MARK,DELETE_MARK) "
            + "values(@ID, @OP_TIME, @PERIOD, @SUBSIDIARY_COUNTS, @FEE_DEBIT, @FEE_CREDIT, @ACCOUNTANT, @BOOKEEPER, @REVIEWER, @REVIEW_MARK, @DELETE_MARK)";
